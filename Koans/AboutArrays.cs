...
namespace DotNetCoreKoans.Koans
{
    public class AboutArrays : Koan
    {
        ...
        {
            var empty_array = new object[] { }; // what is `object`? why the two sets of braces?
            Assert.Equal(typeof(object[]), empty_array.GetType()); // is typeof a function? what is `object[]`?
